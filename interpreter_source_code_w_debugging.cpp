...
// DEBUGGING FLAGS
bool INST_FLAG = true;    // trace instr
bool STEP_FLAG = false;    // step through instr
...
void trace(int ip,char sign, char oper,int op1,int op2, int op3);
...
int main(void)
{
   ...
   char inchar;  // for step debugging 
   ...
   while (1)    // Execution cycle
   {
      ...
      trace(ip,sign,oper,op1,op2,op3);  // DEBUGGING
	  ...
	  switch (sign)
	  {
	   ...
	   if (STEP_FLAG) cin >> inchar;  // DEBUGGING
    };// while    
